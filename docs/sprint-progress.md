...
- **NEXT — Day 11** delta engine + minimal dashboard (+ fix the 3 rollup honesty issues above). **Day 12** discovery mode + nightly runner. **Days 13–14** flywheel live → Kairos's own detection-quality delta → `docs/case-study-1.md`.
